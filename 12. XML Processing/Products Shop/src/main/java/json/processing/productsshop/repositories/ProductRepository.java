...
import json.processing.productsshop.models.view.product.Query4.ProductSoldViewModel;
...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    @Query("SELECT new json.processing.productsshop.models.view.product.Query4.ProductSoldViewModel(p.name, p.price)" +
